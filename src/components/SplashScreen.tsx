...
const SplashScreen = ({ title, image }: SplashScreenProps) => {
  return (
    <div className="flex bg-white max-md:rounded-t-3xl md:rounded-l-3xl flex-col gap-10 md:w-1/2 px-6 pt-10 xl:pt-20 h-full items-center  xl:gap-14 xl:overflow-hidden">
